...
- [[three-box Solution]] — Box 1 (manage present), Box 2 (forget past), Box 3 (create future)
...
### Complexity & Learning
- [[Highlights for pflaegingOrganizeComplexityHow2014|Pflaeging's Organize for Complexity highlights]] — the foundational text for three organizational structures (formal, informal, value creation) and why mastery through disciplined practice matters more than individual performance measurement
- [[Q-DSM Core Values Always Learning|Always Learning core value]] — the Build-Measure-Learn loop as organizational operating system
- [[2025-02-24 AI-Prompting-CLOUs-Operations|CLOUs and operations (2025)]] — the current team self-assessment and CLOU structure, which applies these principles in practice

### Flow & Constraints
- [[Sum The Phoenix Project|The Phoenix Project]] and [[goldrattGoalProcessOngoing2004|Goldratt's work on constraints]] show that bottleneck analysis is the lever for organizational improvement. See [[Sum The Phoenix Project]] for how WIP limits, feedback loops, and the Three Ways of DevOps apply in practice.
...
> Sinek's thesis is that people follow leaders and organizations that communicate their "why" (their purpose and belief) before their "what" or "how." Organizations that start with why attract both talent and supporters who share their convictions. For uW, where our strategic intent is rooted in deep convictions about [[Bible Translation|Bible translation]] and the global church, this book reinforces why articulating purpose precedes everything else in our communication, internally and externally.
...
- [[Parkinson's Law]] — work expands to fill the time available; artificial constraints force focus and simpler solutions
...
- [[Systems Thinking]] — the vault's note on the systems lens Meadows teaches
